...
export const QUESTIONS = [
  // A1
  { id:1,  type:"single_choice", level:"A1", section:"Reading",        points:1, text:"Ընտրի՛ր ճիշտ պատասխանը. «Ես ___ եմ»",
    options:["ուսանող","ուսանողի","ուսանողը","ուսանողին"], correct:0 },
  { id:2,  type:"single_choice", level:"A1", section:"Reading",        points:1, text:"«Բարի լույս» — ե՞րբ ենք ասում",
    options:["երեկոյան","գիշերը","առավոտյան","կեսօրին"], correct:2 },
  { id:3,  type:"fill_blank",    level:"A1", section:"Writing",           points:1, text:"Լրացրո՛ւ բաց թողածը. «Նա ___ է գնում» (դպրոց)", answer:"դպրոց" },
  { id:4,  type:"single_choice", level:"A1", section:"Grammar", points:1, text:"Ո՞ր բառն է անուն",
    options:["վազել","կանաչ","տուն","արագ"], correct:2 },
  { id:5,  type:"multi_choice",  level:"A1", section:"Vocabulary",     points:1, text:"Ո՞ր բառերն են թվեր",
    options:["երկու","կարմիր","հինգ","մեծ","ութ"], correct:[0,2,4] },

  // A2
  { id:6,  type:"single_choice", level:"A2", section:"Reading",        points:1, text:"Ընտրի՛ր ճիշտ ձևը. «Ես ___ դպրոց եմ գնում ամեն օր»",
    options:["դեպի","մոտ","կողքին","առաջ"], correct:0 },
  { id:7,  type:"single_choice", level:"A2", section:"Grammar", points:1, text:"Ո՞ր նախադասությունն է ճիշտ",
    options:["Ես գնացի խանութ","Ես խանութ եմ գնացի","Ես խանութ գնացի եմ","Ես եմ խանութ գնացի"], correct:0 },
  { id:8,  type:"fill_blank",    level:"A2", section:"Writing",           points:1, text:"Լրացրո՛ւ. «Նա ամեն օր ___ է ուտում» (նախաճաշ)", answer:"նախաճաշ" },
  { id:9,  type:"multi_choice",  level:"A2", section:"Vocabulary",     points:2, text:"Ո՞ր բառերն են կապված ընտանիքի հետ",
    options:["մայր","սեղան","հայր","լուսամուտ","քույր"], correct:[0,2,4] },
  { id:10, type:"single_choice", level:"A2", section:"Reading",        points:1, text:"«Ես սիրում եմ երաժշտություն» — ի՞նչ է նշանակում",
    options:["I hate music","I love music","I hear music","I play music"], correct:1 },

  // B1
  { id:11, type:"multi_choice",  level:"B1", section:"Grammar", points:2, text:"Ո՞ր նախադասություններն են քերականորեն ճիշտ",
    options:["Նա գրքեր է կարդում","Ես երեկ կինո գնացի","Նրանք վաղը կգնան","Դու ճաշ ուտում ես արդեն"], correct:[0,1,2] },
  { id:12, type:"single_choice", level:"B1", section:"Reading",        points:2, text:"Ո՞ր բառն է հոմանիշ «ուրախ»-ի",
    options:["տխուր","երջանիկ","հոգնած","բարկացած"], correct:1 },
  { id:13, type:"fill_blank",    level:"B1", section:"Writing",           points:2, text:"Լրացրո՛ւ. «Եթե վաղը անձրև ___, ես տանը կմնամ» (գա)", answer:"գա" },
  { id:14, type:"multi_select",  level:"B1", section:"Vocabulary",     points:2, text:"Ընտրի՛ր բոլոր բառերը, որոնք կապված են «եղանակ»-ի հետ",
    options:["արև","բժիշկ","անձրև","ձյուն","գիրք","քամի"], correct:[0,2,3,5] },
  { id:15, type:"single_choice", level:"B1", section:"Grammar", points:2, text:"Ո՞ր ձևն է ճիշտ. «Եթե ես ժամանակ ___, կկարդայի»",
    options:["ունեմ","ունենամ","ունեի","ունեցել եմ"], correct:2 },

  // B2
  { id:16, type:"multi_select",  level:"B2", section:"Vocabulary",     points:3, text:"Ընտրի՛ր բոլոր բառերը, որոնք կապված են «ճամփորդություն»-ի հետ",
    options:["ինքնաթիռ","բժիշկ","կայարան","ճամպրուկ","դպրոց","անձնագիր"], correct:[0,2,3,5] },
  { id:17, type:"single_choice", level:"B2", section:"Reading",        points:3, text:"Ո՞ր բառն է հականիշ «աղմկոտ»-ի",
    options:["բարձրաձայն","լուռ","ուժեղ","արագ"], correct:1 },
  { id:18, type:"multi_choice",  level:"B2", section:"Grammar", points:3, text:"Ո՞ր ձևերն են ճիշտ",
    options:["Նա ասաց, որ կգա","Ես չգիտեի, թե ինչ անեմ","Երբ տեսա, ուրախացա","Կուզեի, եթե կарողanayir"], correct:[0,1,2] },
  { id:19, type:"fill_blank",    level:"B2", section:"Writing",           points:3, text:"Լրացրո՛ւ. «Չ___ կողմից ստացված նամակը հասավ ուշ» (սպաս)", answer:"սպասված" },
  { id:20, type:"writing",       level:"B2", section:"Free Writing", points:5, text:"Գրի՛ր 80-100 բառ թեմայով. «Ի՞նչ կփոխեի իմ քաղաքում»",
    minWords:80, maxWords:120 },

  // C1
  { id:21, type:"single_choice", level:"C1", section:"Reading",        points:4, text:"Ո՞ր արտահայտությունն է ճիշտ գործածված",
    options:["Ջուրը քարը կոտրեց","Ջուրը քարը փորեց","Ջուրը քար կտրեց","Ջուրը քարին ծակ արեց"], correct:1 },
  { id:22, type:"multi_choice",  level:"C1", section:"Grammar", points:4, text:"Ո՞ր նախադասություններն են ոճական առումով ճիշտ",
    options:["Հանդիպումը կայացավ երեկ","Ժողովը տեղի ունեցավ","Նա ելույթ ունեցավ","Ես ասացի"], correct:[0,1,2] },
  { id:23, type:"fill_blank",    level:"C1", section:"Writing",           points:4, text:"Լրացրո՛ւ դարձվածքը. «Ոսկե ___ ունի» (ձեռքեր)", answer:"ձեռքեր" },
  { id:24, type:"multi_select",  level:"C1", section:"Vocabulary",     points:4, text:"Ո՞ր բառերն են բարձր ոճի",
    options:["ակնկալել","ուզել","հայցել","ասել","հայտնել","ճռճռալ"], correct:[0,2,4] },
  { id:25, type:"writing",       level:"C1", section:"Free Writing", points:8, text:"Գրի՛ր 120-150 բառ. «Ժամանակակից հայերենի մարտահրավերները»",
    minWords:120, maxWords:180 },

  // C2
  { id:26, type:"single_choice", level:"C2", section:"Reading",        points:5, text:"Ո՞ր բառն է ճշգրիտ. «Հեղինակը ___ ոճ է գործածել» (պատկերավոր)",
    options:["փոխաբերական","ուղիղ","բառացի","զգացմունքային"], correct:0 },
  { id:27, type:"multi_choice",  level:"C2", section:"Grammar", points:5, text:"Ո՞ր նախադասություններն են ճիշտ կազմված",
    options:["Այն, ինչ ասացիր, ճշմարիտ է","Ով ջանա՝ կհասնի","Ուր գնաս, ես կգամ","Թեեւ հոգնած էր, շարունակեց"], correct:[0,1,2,3] },
  { id:28, type:"fill_blank",    level:"C2", section:"Writing",           points:5, text:"Լրացրո՛ւ. «___ չէ, ով բոլորին հաճոյանա» (մարդ)", answer:"մարդ" },
  { id:29, type:"multi_select",  level:"C2", section:"Vocabulary",     points:5, text:"Ո՞ր բառերն են արխաիզմներ",
    options:["շնորհ","ոգի","յուր","նա","ահա","ես"], correct:[2] },
  { id:30, type:"writing",       level:"C2", section:"Free Writing", points:10, text:"Գրի՛ր 150-200 բառ. «Գրականության դերը ազգային ինքնության պահպանման մեջ»",
    minWords:150, maxWords:220 },

  // Word Bank examples
  { id:31, type:"fill_wordbank", level:"A2", section:"Grammar", points:2,
  ...
  { id:32, type:"fill_wordbank", level:"B1", section:"Vocabulary", points:3,
  ...
  // ── Audio questions ──────────────────────────────────────────────────────────
  { id:33, type:"audio", level:"A2", section:"Listening", points:2,
  ...
  { id:34, type:"audio", level:"B1", section:"Listening", points:3,
  ...
  { id:37, type:"voice", level:"B1", section:"Speaking", points:3,
  ...
  { id:38, type:"voice", level:"C1", section:"Speaking", points:5,
...
export const EXAMS = [
  { id:1, title:"Summer B1 Examination",  examType:"fixed",     level:"B1", duration:45,  passingScore:70, shuffle:true,  showResults:true, showQuestionLevel:true, showQuestionPoints:true,
    subpools:[{ section:"Reading", count:3 },{ section:"Grammar", count:2 },{ section:"Vocabulary", count:2 }],
    assignedTo:[1,2,7], status:"active", startDate:"2025-06-01", endDate:"2025-09-30", createdAt:"2025-05-15" },
  { id:2, title:"A2 Entrance Test",        examType:"fixed",     level:"A2", duration:30,  passingScore:60, shuffle:false, showResults:true, showQuestionLevel:true, showQuestionPoints:true,
    subpools:[{ section:"Reading", count:3 },{ section:"Grammar", count:2 }],
    assignedTo:[2,7], status:"active", startDate:"2025-07-01", endDate:"2025-09-30", createdAt:"2025-05-20" },
  { id:3, title:"C1–C2 Final Examination", examType:"fixed",     level:"C1", duration:60,  passingScore:80, shuffle:true,  showResults:true, showQuestionLevel:true, showQuestionPoints:true,
    subpools:[{ section:"Reading", count:2 },{ section:"Listening", count:2 },{ section:"Writing", count:1 }],
    assignedTo:[3,4,8], status:"active", startDate:"2025-04-10", endDate:"2025-12-31", createdAt:"2025-04-01" },
  { id:4, title:"Language Placement Test", examType:"placement", level:null, duration:60, passingScore:null, shuffle:true, showResults:true, showQuestionLevel:true, showQuestionPoints:true,
    assignedTo:[1,2,3,4,5,6,7,8], status:"active", startDate:"2025-09-01", endDate:"2025-12-31", createdAt:"2025-08-01",
    placementTemplate:[
